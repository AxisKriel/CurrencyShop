...
namespace ShopManager.ID
{
	public class ItemID
	{
		public static Dictionary<int, string> NetIdToName
		{
			get
			{
				var dict = new Dictionary<int, string>();
				foreach (FieldInfo f in App.GetConstants(typeof(ItemID)))
				{
					short num = (short)f.GetValue(null);
					if (!dict.ContainsKey(num))
						dict.Add(num, SeparateStringByUpper(f.Name));
				}
				return dict;
			}
		}

		public static string SeparateStringByUpper(string s)
		{
